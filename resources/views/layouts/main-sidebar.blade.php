<div class="container-fluid" >
    <div class="row">
        <!-- Left Sidebar start-->
        <div class="side-menu-fixed" style="overflow: scroll" >
                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="mail-box.html"><i class="ti-email"></i><span class="right-nav-text">Mail
                                box  <span class="badge badge-pill badge-warning float-right mt-1">HOT</span></span> </a>
                    </li>
                    <!-- menu item Charts-->
                    <li>
                    ...
                    <!-- menu item Widgets-->
                    <li>
                        <a href="widgets.html"><i class="ti-blackboard"></i><span class="right-nav-text">Widgets
